...
//         this.checkConnection();
//         try {
//             const result = await this.questionDao!.query(`SELECT COUNT(*) FROM question`);
//             return parseInt(result[0].count);
//         } catch (error) {
//             this.logDbError("countQuestion", error);
//             throw error;
...
//             return parseInt(result[0].count);
//         } catch (error) {
//             this.logDbError("countQuestionBySetNumberID", error);
//             throw error;
//         }
//     }
...
//                 // ✅ sync sequence ก่อน insert ทุกครั้ง
//                 await this.questionDao!.query(`
//                   SELECT setval(
//                     pg_get_serial_sequence('question','question_id'),
//                     COALESCE((SELECT MAX(question_id) FROM question), 0) + 1,
//                     false
//                   )
//                 `);
...
//                 // หา question_number ถัดไปใน set_number เดียวกัน
//                 const nextRows = await this.questionDao!.query(
//                     `SELECT COALESCE(MAX(question_number), 0) + 1 AS n
//                      FROM question WHERE set_number_id = $1`,
//                     [set_number_id]
...
//                 const rows = await this.questionDao!.query(
//                     `INSERT INTO question (question_text, question_number, set_number_id, question_type)
//                      VALUES ($1, $2, $3, $4::question_question_type_enum)
//                      RETURNING *`,
//                     [q, nextNumber, set_number_id, t]
//                 );
...
//                 // ถ้าเจอ PK ชนเพราะ sequence เพี้ยน → reset แล้วลองใหม่
//                 if (!retried && err?.code === "23505" && /question_id/i.test(err?.detail ?? "")) {
//                     retried = true;
//                     await this.questionDao!.query(`
//                         SELECT setval(
...
//             );
//         } catch (error) {
//             this.logDbError("updateQuestionByText", error);
//             throw error;
//         }
//     }
...
//             );
//         } catch (error) {
//             this.logDbError("updateQuestionByType", error);
//             throw error;
//         }
//     }
...
//             );
//         } catch (error) {
//             this.logDbError("updateQuestionByTextType", error);
//             throw error;
//         }
//     }
...
//         try {
//             return await this.questionDao!.query(
//                 `DELETE FROM question WHERE set_number_id = $1 RETURNING *`,
//                 [set_number_id]
//             );
//         } catch (error) {
//             this.logDbError("deleteQuestionBySetNumberID", error);
