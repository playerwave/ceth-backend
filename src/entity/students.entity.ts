...
export class Students {
  @PrimaryGeneratedColumn() students_id!: number;
  @ManyToOne(() => Users, (users) => users.students)
  @JoinColumn({ name: "users_id" })
  users!: Users;
  @Column({ type: "int" }) users_id!: number;
  ...
  email?: string;
  @Column({ type: "int", nullable: true }) soft_hours?: number;
  @Column({ type: "int", nullable: true }) hard_hours?: number;
  ...
  faculty!: Faculty;
  @Column({ type: "int", nullable: true }) faculty_id?: number;
  @ManyToOne(() => Department, (department) => department.students)
  @JoinColumn({ name: "department_id" })
  department!: Department;
  @Column({ type: "int", nullable: true }) department_id?: number;
  @ManyToOne(() => Grade, (grade) => grade.students)
  @JoinColumn({ name: "grade_id" })
  grade!: Grade;
  @Column({ type: "int", nullable: true }) grade_id?: number;
  @ManyToOne(() => EventCoop, (eventCoop) => eventCoop.students)
  @JoinColumn({ name: "eventcoop_id" })
  eventCoop!: EventCoop;
  @Column({ type: "enum", enum: ["Active", "InActive"], default: "Active" })
  status!: "Active" | "InActive";
  @Column({ type: "int", nullable: true }) eventcoop_id?: number;
  @OneToMany(() => Join, (join) => join.students) join?: Join[];
